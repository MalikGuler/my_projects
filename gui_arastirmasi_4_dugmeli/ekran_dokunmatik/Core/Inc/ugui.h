...
typedef struct {
    ...
    uint8_t top_index; // Scroll için en üstteki öğe
    UG_S16 x, y;
    UG_S16 width, height;
    UG_COLOR bg_color;
    UG_COLOR fg_color;
...
void UG_MenuDraw(UG_Menu* menu);
void UG_MenuNext(UG_Menu* menu);
void UG_MenuPrev(UG_Menu* menu);
void UG_MenuSelect(UG_Menu* menu);
void UG_MenuInit(UG_Menu* menu, UG_MenuItem* items, uint8_t item_count, UG_S16 x, UG_S16 y, UG_S16 width, UG_S16 height, UG_COLOR bg, UG_COLOR fg, UG_COLOR sel, UG_FONT* font);
