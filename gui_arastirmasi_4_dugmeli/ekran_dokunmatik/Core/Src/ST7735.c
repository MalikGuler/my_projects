...
void ST7735_ClearSprite(uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint16_t bgColor) {
    ST7735_FillRectangle(x, y, w, h, bgColor);
}


void FillScreen(uint16_t color) {
	ST7735_FillRectangle(0, 0, 128, 64, color);
}
